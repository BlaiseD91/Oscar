...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Máj 02. 10:50
...
-- Adatbázis: `oscar`
--
CREATE DATABASE IF NOT EXISTS `oscar` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `oscar`;
...
('adre48', 'The Treasure of the Sierra Mad', 1948, 3, 4),
...
('Days56', 'Around the World in Eighty Day', 1956, 5, 8),
...
('hing55', 'Love Is a Many-Splendored Thin', 1955, 3, 8),
...
('Kid69', 'Butch Cassidy and the Sundance', 1969, 4, 7),
('King03', 'The Lord of the Rings: The Ret', 2003, 11, 11),
...
('Nest75', 'One Flew over the Cuckoo\'s Nes', 1975, 5, 9),
...
('Ring01', 'The Lord of the Rings: The Fel', 2001, 4, 13),
...
('tton08', 'The Curious Case of Benjamin B', 2008, 3, 13),
